					...
					<div className="col-10 mx-auto">
						{cart.map((courses) => (
							<div className="row d-flex justify-content-center" key={courses.id}>
								...
								<div className="col-md-3">
									<p>
										<FontAwesomeIcon icon={faVideo} /> {courses.Course_name}
									</p>
								</div>
								<div className="col-md-4">
									<p>
										<FontAwesomeIcon icon={faUniversity} /> {courses.Institution_name}
									</p>
								</div>
								<div className="col-md-3">
									<p>
										<FontAwesomeIcon icon={faDollarSign} /> {courses.price}
									</p>
								</div>
							</div>
						))}
						...
						<div className="row d-flex justify-content-center">
							<p className="lead text-center my-5">
								Total Price: <FontAwesomeIcon icon={faDollarSign} /> <strong> {totalPrice}</strong>
							</p>

							<div className="col-md-6 d-flex justify-content-center">
								{totalPrice > 0 ? (
									<button onClick={handleProceedCheckout} className="btn btn-success">
										<FontAwesomeIcon icon={faCheckSquare} /> Proceed to checkout
									</button>
								) : (
									<Link to="/courses" className="btn btn-secondary">
										<FontAwesomeIcon icon={faShoppingCart} /> Buy any Course
									</Link>
								)}
							</div>
						</div>
